...
$routes->scope('/', function (RouteBuilder $builder) {
    ...
    */
    ...
    $builder->connect('/pet/add', ['controller' => 'Pets', 'action' => 'add']);
    ...
    $builder->connect('/adoptions/pet/:id', ['controller' => 'RequestAdoptions', 'action' => 'index'],['pass' => ['id'],'id' => '[0-9]+']);
    $builder->connect('/adoptions/:id', ['controller' => 'RequestAdoptions', 'action' => 'view'],['pass' => ['id'],'id' => '[0-9]+']);
